...
import { Upload, CheckCircle2, FileText, Info, Loader2, X } from "lucide-react";
      ...
      <div className="max-w-lg mx-auto animate-scale-in">
        <Card className="bg-card border border-border shadow-sm rounded-xl">
          <CardContent className="p-12 flex flex-col items-center text-center gap-6">
            ...
            >
              {mintedTxHash.slice(0, 20)}...{mintedTxHash.slice(-8)}
            </a>
        ...
        <CardContent className="p-6 space-y-6">
          ...
          <div className="space-y-2">
            ...
            {errors.patientWallet && (
              <p className="text-sm text-destructive">{errors.patientWallet}</p>
            )}
          </div>
